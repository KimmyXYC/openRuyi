...
0150-UPSTREAM-net-stmmac-add-phy_intf_sel-and-ACTPHYIF-de.patch
0151-UPSTREAM-net-stmmac-add-stmmac_get_phy_intf_sel.patch
0152-UPSTREAM-net-stmmac-add-support-for-configuring-the-.patch
0153-UPSTREAM-net-stmmac-imx-convert-to-PHY_INTF_SEL_xxx.patch
0154-UPSTREAM-net-stmmac-imx-use-FIELD_PREP-FIELD_GET-for.patch
0155-UPSTREAM-net-stmmac-imx-use-stmmac_get_phy_intf_sel.patch
0156-UPSTREAM-net-stmmac-imx-simplify-set_intf_mode-imple.patch
0157-UPSTREAM-net-stmmac-imx-cleanup-arguments-for-set_in.patch
0158-UPSTREAM-net-stmmac-imx-use-set_phy_intf_sel.patch
0159-UPSTREAM-powerpc-pci-Initialize-msi_addr_mask-for-OF.patch
0160-UPSTREAM-sparc-PCI-Initialize-msi_addr_mask-for-OF-c.patch
0161-FROMLIST-riscv-errata-Add-ERRATA_THEAD_WRITE_ONCE-fi.patch
0162-FROMLIST-PCI-Release-BAR0-of-an-integrated-bridge-to.patch
0163-BACKPORT-FROMLIST-drm-ttm-save-the-device-s-DMA-cohe.patch
0164-BACKPORT-FROMLIST-drm-ttm-downgrade-cached-to-write_.patch
0165-FROMLIST-NFU-riscv-dts-thead-Add-CPU-clock-and-OPP-t.patch
0166-FROMLIST-dt-bindings-vendor-prefixes-add-verisilicon.patch
0167-FROMLIST-dt-bindings-display-add-verisilicon-dc.patch
0168-FROMLIST-drm-verisilicon-add-a-driver-for-Verisilico.patch
0169-FROMLIST-dt-bindings-display-bridge-add-binding-for-.patch
0170-FROMLIST-drm-bridge-add-a-driver-for-T-Head-TH1520-H.patch
0171-FROMLIST-riscv-dts-thead-add-DPU-and-HDMI-device-tre.patch
0172-FROMLIST-riscv-dts-thead-lichee-pi-4a-enable-HDMI.patch
0173-FROMLIST-MAINTAINERS-assign-myself-as-maintainer-for.patch
0174-FROMLIST-mailmap-map-all-Icenowy-Zheng-s-mail-addres.patch
0175-FROMLIST-dt-bindings-usb-Add-T-HEAD-TH1520-USB-contr.patch
0176-FROMLIST-usb-dwc3-add-T-HEAD-TH1520-usb-driver.patch
0177-FROMLIST-rust-export-BINDGEN_TARGET-from-a-separate-.patch
0178-FROMLIST-rust-generate-a-fatal-error-if-BINDGEN_TARG.patch
0179-FROMLIST-rust-add-a-Kconfig-function-to-test-for-sup.patch
0180-FROMLIST-RISC-V-handle-extension-configs-for-bindgen.patch
0181-FROMLIST-rust-clk-implement-Send-and-Sync.patch
0182-FROMLIST-tyr-remove-impl-Send-Sync-for-TyrData.patch
0183-FROMLIST-pwm-th1520-remove-impl-Send-Sync-for-Th1520.patch
0184-FROMLIST-dt-bindings-mmc-spacemit-sdhci-add-reset-su.patch
0185-FROMLIST-mmc-sdhci-of-k1-add-reset-support.patch
0186-FROMLIST-i2c-spacemit-move-i2c_xfer_msg.patch
0187-FROMLIST-i2c-spacemit-introduce-pio-for-k1.patch
0188-FROMLIST-mfd-simple-mfd-i2c-add-a-reboot-cell-for-th.patch
0189-FROMLIST-regulator-spacemit-MFD_SPACEMIT_P1-as-depen.patch
0190-FROMLIST-rtc-spacemit-default-module-when-MFD_SPACEM.patch
0191-FROMLIST-dt-bindings-spi-add-SpacemiT-K1-SPI-support.patch
0192-FROMLIST-spi-spacemit-introduce-SpacemiT-K1-SPI-cont.patch
0193-FROMLIST-riscv-dts-spacemit-define-a-SPI-controller-.patch
0194-FROMLIST-dt-bindings-thermal-Add-SpacemiT-K1-thermal.patch
0195-FROMLIST-thermal-spacemit-k1-Add-thermal-sensor-supp.patch
0196-FROMLIST-riscv-dts-spacemit-Add-thermal-sensor-for-K.patch
0197-FROMLIST-pwm-th1520-fix-CLIPPY-1-warning.patch
0198-FROMLIST-dt-bindings-mfd-spacemit-p1-Add-individual-.patch
0199-FROMLIST-regulator-spacemit-p1-Update-supply-names.patch
0200-FROMLIST-riscv-dts-spacemit-Update-PMIC-supply-prope.patch
0201-FROMLIST-dt-bindings-mmc-spacemit-sdhci-add-support-.patch
0202-FROMLIST-mmc-sdhci-of-k1-spacemit-Add-support-for-K3.patch
0203-FROMLIST-PCI-cadence-Support-platform-specific-hooks.patch
0204-FROMLIST-PCI-sg2042-Avoid-L0s-and-L1-on-Sophgo-2042-.patch
0205-FROMLIST-riscv-dts-spacemit-adapt-regulator-node-nam.patch
0206-FROMLIST-riscv-dts-spacemit-pcie-fix-missing-power-r.patch
0207-FROMLIST-net-spacemit-Remove-unused-buff_addr-fields.patch
0208-FROMLIST-net-spacemit-Fix-error-handling-in-emac_all.patch
0209-FROMLIST-net-spacemit-Fix-error-handling-in-emac_tx_.patch
0210-FROMLIST-net-spacemit-Free-rings-of-memory-after-unm.patch
0211-FROMLIST-riscv-mm-Extract-helper-mark_new_valid_map.patch
0212-FROMLIST-riscv-kfence-Call-mark_new_valid_map-for-kf.patch
0213-FROMLIST-riscv-mm-Rename-new_vmalloc-into-new_valid_.patch
0214-FROMLIST-riscv-mm-Use-the-bitmap-API-for-new_valid_m.patch
0215-FROMLIST-riscv-mm-Unconditionally-sfence.vma-for-spu.patch
0216-FROMLIST-dt-bindings-serial-8250-spacemit-fix-clock-.patch
0217-FROMLIST-riscv-dts-spacemit-k3-add-clock-tree.patch
0218-FROMLIST-riscv-dts-spacemit-k3-add-pinctrl-support.patch
0219-FROMLIST-riscv-dts-spacemit-k3-add-GPIO-support.patch
0220-FROMLIST-riscv-dts-spacemit-k3-add-full-resource-to-.patch
0221-FROMLIST-dt-bindings-net-Add-support-for-Spacemit-K3.patch
0222-FROMLIST-net-stmmac-platform-Add-snps-dwmac-5.40a-IP.patch
0223-FROMLIST-net-stmmac-Add-glue-layer-for-Spacemit-K3-S.patch
0224-FROMLIST-riscv-dts-spacemit-k3-Add-ethernet-device-n.patch
0225-FROMLIST-phy-k1-usb-add-disconnect-function-support.patch
0226-FROMLIST-dt-bindings-phy-spacemit-k3-add-USB2-PHY-su.patch
0227-FROMLIST-phy-k1-usb-k3-add-USB2-PHY-support.patch
0228-FROMLIST-clk-spacemit-ccu_mix-fix-inverted-condition.patch
0229-FROMLIST-riscv-enable-HAVE_IOREMAP_PROT.patch
0230-FROMLIST-cpufreq-dt-platdev-Add-SpacemiT-K1-SoC-to-t.patch
0231-FROMLIST-riscv-dts-spacemit-Add-cpu-scaling-for-K1-S.patch
0232-FROMLIST-riscv-dts-spacemit-Add-linux-pci-domain-to-.patch
0233-FROMLIST-riscv-mm-WARN_ON-for-bad-addresses-in-vmemm.patch
0234-FROMLIST-riscv-mm-Define-DIRECT_MAP_PHYSMEM_END.patch
0235-FROMLIST-drm-verisilicon-add-max-cursor-size-to-HWDB.patch
0236-FROMLIST-drm-verisilicon-add-support-for-cursor-plan.patch
0237-FROMLIST-riscv-dts-spacemit-Enable-i2c8-adapter-for-.patch
0238-FROMLIST-riscv-dts-spacemit-Define-fixed-regulators-.patch
0239-FROMLIST-riscv-dts-spacemit-Define-the-P1-PMIC-regul.patch
0240-FROMLIST-riscv-dts-spacemit-Enable-USB3.0-PCIe-on-Or.patch
0241-FROMLIST-dt-bindings-hwmon-moortec-mr75203-adapt-mul.patch
0242-FROMLIST-riscv-dts-thead-th1520-add-coefficients-to-.patch
0243-FROMLIST-pinctrl-spacemit-return-ENOTSUPP-for-unsupp.patch
0244-FROMLIST-gpio-spacemit-k1-Add-set_config-callback-su.patch
0245-FROMLIST-reset-spacemit-k3-Decouple-composite-reset-.patch
0246-FROMLIST-irqchip-riscv-rpmi-sysmsi-Fix-mailbox-chann.patch
0247-XUANTIE-riscv-dts-th1520-add-licheepi4a-16g-support.patch
0248-XUANTIE-riscv-dts-thead-Add-TH1520-USB-nodes.patch
0249-XUANTIE-riscv-dts-thead-Add-TH1520-I2C-nodes.patch
0250-XUANTIE-riscv-dts-thead-Add-Lichee-Pi-4A-IO-expansio.patch
0251-XUANTIE-riscv-dts-thead-Enable-Lichee-Pi-4A-USB.patch
0252-REVYOS-riscv-dts-th1520-rename-thead-to-xuantie.patch
0253-REVYOS-riscv-dts-th1520-add-xuantie-th1520-mbox-r.patch
0254-SOPHGO-dt-bindings-nvmem-Add-SG2044-eFuse-controller.patch
0255-SOPHGO-nvmem-Add-Sophgo-SG2044-eFuse-driver.patch
0256-SOPHGO-riscv-dts-sophgo-sg2044-Add-eFUSE-device.patch
0257-SOPHGO-dts-sg2044-Modify-pcie-bar-address.patch
0258-SOPHGO-riscv-sg2042-errata-Replace-thead-cache-clean.patch
0259-REVYSR-dt-bindings-net-ultrarisc-dp1000-gmac-Add-sup.patch
0260-REVYSR-net-stmmac-add-support-for-dwmac-5.10a.patch
0261-RVCK-riscv-dp1000-8250_dw-support-ultrarisc-dp1000-u.patch
0262-RVCK-riscv-dts-add-dp1000.dts-for-UltraRIsc-DP1000-S.patch
0263-RVCK-riscv-dp1000-arch-add-UltraRISC-DP1000-SoC-supp.patch
0264-RVCK-riscv-dp1000-pci-support-UltraRISC-pcie-rc.patch
0265-RVCK-pinctrl-add-pinctrl-dirver-for-UltraRisc-DP1000.patch
0266-RVCK-dts-add-pinctrl-dtsi-dts-for-UltraRisc-DP1000.patch
0267-RVCK-riscv-dp1000-pci-Add-custom-PCI-host-ops.patch
0268-RVCK-riscv-dp1000-dts-add-the-dts-of-UltraRISC-dp100.patch
0269-RVCK-riscv-dp1000-dts-Move-mmc0-node-from-SoC-to-boa.patch
0270-RVCK-riscv-dp1000-plic-add-plic-early-init-supports.patch
0271-RVCK-pcie-ultrarisc-Add-suspend-resume-support.patch
0272-RVCK-riscv-dp1000-dts-Move-chosen-node-from-common-t.patch
0273-RVCK-dts-riscv-ultrarisc-Refactor-DP1000-device-tree.patch
0274-RVCK-riscv-pinctrl-ultrarisc-Implement-pin-configura.patch
0275-RVCK-riscv-dts-dp1000-add-dts-dtsi-for-Milk-V-Titan-.patch
0276-REVYSR-pinctrl-ultrarisc-cleanup-probe-remove.patch
